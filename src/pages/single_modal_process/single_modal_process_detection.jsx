...
class SingleModalProcessDetection extends Component {
    ...
    _submit = async (title) => {
        ...
        if (title === 'rgb') {
            ...
            let data = {"algorithm": "CrackDetection", 'method_name': "crackdetection", 'input_path': this.state.selected_data_rgb.data_url, 'Sensor_ID': this.state.selected_data_rgb.number};
            console.log(data);
            ...
            if(res.success === 1) {
                ...
                let temp_item = {
                    ...
                    data_type: this.state.selected_data_rgb.data_type,
                }
                this.setState({
    ...
    showComponent=(item, bim_show_sufix)=>{
        ...
        if(data_type==="点云"){
            return(
                <BIMShow div_id={item.number+bim_show_sufix+"process_det"} model_url={item.data_url} height={144} width={256}/>
            )
        }
    };
    ...
    showComponent2=(item, bim_show_sufix)=>{
        ...
        if(data_type==="点云"){
            return(
                <BIMShow div_id={bim_show_sufix+"process_det"} model_url={item.data_url} height={250} width={400}/>
            )
        }
    };
