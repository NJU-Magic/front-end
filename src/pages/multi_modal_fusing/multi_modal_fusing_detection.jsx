...
class MultiModalFusingDetection extends Component {
	rgb_flag = "none";
	depth_flag = "none";
	nir_flag = "none";
	recx_flag = "none";
    ...
    render() {
        ...
        // console.log(this.rgb_flag, this.depth_flag)
		return (
            <div>
                <div style={{display: "flex"}}>
                    <div>
						...
						// depth
                        <div style={{backgroundColor: "#e4e2e9", marginTop: "50px", display: this.depth_flag}}>
                            <div style={{textAlign: "center", fontColor: "#000000", fontSize: "30px"}}>深度图</div>
                            <div style={{display: "flex", padding: "30px"}}>
                                <div>
                                    <div style={{textAlign: "center", fontColor: "#000000", fontSize: "20px"}}>输入</div>
                                    <div style={{margin: "10px"}}>
						...
						// nir
                        <div style={{backgroundColor: "#e4e2e9", marginTop: "50px", display: this.nir_flag}}>
                            <div style={{textAlign: "center", fontColor: "#000000", fontSize: "30px"}}>红外光</div>
                            <div style={{display: "flex", padding: "30px"}}>
                                <div>
                                    <div style={{textAlign: "center", fontColor: "#000000", fontSize: "20px"}}>输入</div>
                                    <div style={{margin: "10px"}}>
						...
						// recx
                        <div style={{backgroundColor: "#e4e2e9", marginTop: "50px", display: this.recx_flag}}>
                            <div style={{textAlign: "center", fontColor: "#000000", fontSize: "30px"}}>热成像</div>
                            <div style={{display: "flex", padding: "30px"}}>
                                <div>
                                    <div style={{textAlign: "center", fontColor: "#000000", fontSize: "20px"}}>输入</div>
                                    <div style={{margin: "10px"}}>
...
export default withRouter(MultiModalFusingDetection)