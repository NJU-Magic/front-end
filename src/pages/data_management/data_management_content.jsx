...
class DataResearchBody extends Component{
    ...
    render(){
        ...
        return (
            <div>
                <div id="dia_d" className="modal_d">
                  <div className="modal-content_d">
                      <ul id="input_data1" className="input_data">
                        <li>Data 1</li>
                          <li><input type="file"/> <img src="" alt=""/></li>
                          {/*<li className="but_d"><button className="d_but_d" id="b_select" onClick={()=>read_img()}>选择数据</button></li>*/}
